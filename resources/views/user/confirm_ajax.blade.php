        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <div class="alert alert-danger"> 
                    ...
                    The data ur search it not found</div> 
        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <div class="alert alert-warning"> 
                    ...
                    Are u sure delete data in the above? 
                </div> 
                <table class="table table-sm table-bordered table-striped"> 
                    <tr><th class="text-right col-3">Level User :</th><td class="col-9">{{ 
...
$user->username }}</td></tr> 
            ...
            <div class="modal-footer"> 
                ...
                <button type="submit" class="btn btn-primary">Yes, delete the data</button> 
            </div> 
        </div> 
    </div> 
    </form> 
